package snowant.com.homework2.data;
...
import snowant.com.homework2.NewsItem;
import snowant.com.homework2.data.Category;
...
public class DataUtils {
    ...
    public static List<NewsItem> generateNews(long testTime)  {

        try {
            Thread.sleep(testTime);
            Log.d("rrtt",Thread.currentThread().getName());
